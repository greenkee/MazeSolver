...
def PID(path, params, elapsed): #time elapsed in seconds
    ...
    #print steeringRad
    roomba.tankDrive(.5, steeringRad)
...
def replan():
  ...
  targetPoint = (roomba.getX() + 1.5*startRadius * math.cos(targetAngle), roomba.getY() + 1.5*startRadius * math.sin(targetAngle)) #moves 1.5 lengths forward
  return targetPoint
